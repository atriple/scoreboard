...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$1, 34, 4, 756);
    			dispose = listen(button, "click", ctx.toggleConfirm);
    		},
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			button0.textContent = "You sure?";
    			t_1 = space();
    			button1 = element("button");
    			button1.textContent = "Cancel";
    			button0.className = "btn btn-danger btn-sm";
    			add_location(button0, file$1, 37, 4, 873);
    			button1.className = "btn btn-sm";
    			add_location(button1, file$1, 38, 4, 954);

    			dispose = [
    				listen(button0, "click", ctx.onDelete),
    				listen(button1, "click", ctx.toggleConfirm)
    			];
    		},
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button0, file$1, 43, 4, 1093);
    			button1.className = "btn btn-dark";
    			add_location(button1, file$1, 44, 4, 1149);
    			attr(input, "type", "number");
    			add_location(input, file$1, 45, 4, 1217);
    ...
    function create_fragment$1(ctx) {
    	var div, h1, t0, t1, button, t2, t3, t4, h3, t5, t6, t7, dispose;

    	function select_block_type(ctx) {
    		if (ctx.showControls) return create_if_block_3;
    	...
    	var if_block1 = (!ctx.deleteConfirm) && create_if_block_2(ctx);

    	var if_block2 = (ctx.deleteConfirm) && create_if_block_1(ctx);

    	var if_block3 = (ctx.showControls) && create_if_block(ctx);
    	...
    	return {
    		c: function create() {
    			...
    			add_location(button, file$1, 30, 4, 609);
    			h1.className = "svelte-1ekm9jl";
    			add_location(h1, file$1, 28, 2, 588);
    			h3.className = "svelte-1ekm9jl";
    			add_location(h3, file$1, 41, 2, 1042);
    			div.className = "card";
    			add_location(div, file$1, 27, 0, 567);
    ...
    function instance($$self, $$props, $$invalidate) {
      ...
      const toggleConfirm = () => { const $$result = (deleteConfirm = !deleteConfirm); $$invalidate('deleteConfirm', deleteConfirm); return $$result; };
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(p, file$3, 34, 4, 634);
    		},
    ...
    function create_fragment$3(ctx) {
    	...
    	return {
    		c: function create() {
    			...
    			add_location(div, file$3, 31, 0, 536);
    		},
